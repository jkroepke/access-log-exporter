...
fmt:
	...
	@-go run golang.org/x/tools/cmd/goimports@v0.44.0 -l -w .
	@-go run github.com/bombsimon/wsl/v5/cmd/wsl@v5.8.0 -fix ./...
	...
	@-go run golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.44.0 -test=false -fix ./...
