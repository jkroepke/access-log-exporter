...
fmt:
	...
	@-go run golang.org/x/tools/cmd/goimports@v0.50.0 -l -w .
	...
	@-go run github.com/4meepo/tagalign/cmd/tagalign@v1.4.4 -fix -sort ./...
	@-go run golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.50.0 -test=false -fix ./...
