...
fmt:
	...
	@-go run golang.org/x/tools/cmd/goimports@v0.39.0 -l -w .
	@-go run github.com/bombsimon/wsl/v5/cmd/wsl@v5.3.0 -fix ./...
	...
	@-go run golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.39.0 -test=false -fix ./...
	@-go run github.com/golangci/golangci-lint/v2/cmd/golangci-lint@v2.7.1 run ./...
...
3rdpartylicenses:
	@go run github.com/google/go-licenses/v2@v2.0.1 save ./cmd/access-log-exporter --save_path=3rdpartylicenses
