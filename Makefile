...
fmt:
	...
	@-go run golang.org/x/tools/cmd/goimports@v0.37.0 -l -w .
	...
	@-go run golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.37.0 -test=false -fix ./...
